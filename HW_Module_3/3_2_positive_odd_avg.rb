...
# та додавання парних елементів до результату.
    ...
    # 3. Якщо індекс парний, то переходимо до пункту 7# Написати програму, яка обчислює середнє арифметичне всіх парних додатніх чисел
  ...
  def mean_odd_positive
    ...
    while loop_index < arr.length() do
        if (loop_index%2) != 0
            ...
            if (arr[loop_index].to_i%2) != 0
                loop_index+=1
            else
                sum_of_odd_positive += arr[loop_index].to_i
